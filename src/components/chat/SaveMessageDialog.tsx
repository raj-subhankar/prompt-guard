...
export const SaveMessageDialog = React.memo<SaveMessageDialogProps>(
  ({ content, categories, onSave, disabled }) => {
    ...
    const handleSave = useCallback(() => {
      ...
      onSave(title.trim(), editableContent, category);
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button
                ...
                disabled={
                  ...
                  (!selectedCategory && !newCategory.trim() && useNewCategory)
                }
              >
                Save to Library
              </Button>
